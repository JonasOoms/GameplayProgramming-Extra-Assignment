...
void App_Sandbox::Update(float deltaTime)
{
	...
	//UI
	{
		...
		ImGui::Text("KINEMATIC BEHAVIORS");
		ImGui::PushItemWidth(180);
		int itemSelected = m_pActor->GetCurrentBehaviour();
		ImGui::Combo("", &itemSelected, "SeekAndArrive\0Wander\0", 4);
		m_pActor->SetCurrentBehaviour(itemSelected);
		ImGui::PopItemWidth();
