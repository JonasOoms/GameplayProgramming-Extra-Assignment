...
namespace Elite
{
	...
	public:
		...
		virtual GraphNode* const CreateNode(const Elite::Vector2& pos) const = 0;
	...
	public:
		...
		GraphNode* const CreateNode(const Elite::Vector2& pos) const  override { return new T_GraphNode(pos); }
