...
namespace Elite
{
	...
	public:
		...
		GridGraph(int columns, int rows, int cellSize, bool isDirectionalGraph, bool isConnectedDiagonally, float costStraight = 1.f, 
		...
		GraphNode* const GetNodeAtPosition(const Vector2& pos) const override;
	...
	private:
		...
		void InitializeGrid();
		void AddConnectionsInDirections(int idx, int col, int row, const std::vector<Vector2>& directions);
