...
void FiniteStateMachine::AddTransition(FSMState* const startState, FSMState* const toState, FSMCondition* const condition)
{
...
Blackboard* const FiniteStateMachine::GetBlackboard() const
{
