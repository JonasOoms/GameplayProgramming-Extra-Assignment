...
Matrix2x3::Matrix2x3(const Elite::Vector2& dirX, const Elite::Vector2& dirY, const Elite::Vector2& orig)
...
void Matrix2x3::SetAsTranslate(const Elite::Vector2& pt)
{
	dirX = Elite::Vector2{ 1, 0 };
	dirY = Elite::Vector2{ 0, 1 };
...
Matrix2x3 Matrix2x3::CreateScalingMatrix(const Elite::Vector2& scaleVector)
{
...
Matrix2x3 Matrix2x3::CreateTranslationMatrix(const Elite::Vector2& origin)
{
