...
struct Matrix2x3 final
{
	...
	explicit Matrix2x3( 
		const Elite::Vector2& dirX = Elite::Vector2{ 1, 0 }, 
		const Elite::Vector2& dirY = Elite::Vector2{ 0, 1 }, 
		const Elite::Vector2& origTrans = Elite::Vector2{ 0, 0 });
	...
	// Converts this matrix into a Translation matrix
	void SetAsTranslate(const Elite::Vector2& pt);
	...
	static Matrix2x3 CreateScalingMatrix(const Elite::Vector2& scaleVector);
	// Instantiate a translation matrix: 
	// Matrix matTrans = Matrix::Translation( Elite::Vector2(2.0f,3.0f) );
	static Matrix2x3 CreateTranslationMatrix(const Elite::Vector2& origin);
	// Instantiate a translation matrix: 
