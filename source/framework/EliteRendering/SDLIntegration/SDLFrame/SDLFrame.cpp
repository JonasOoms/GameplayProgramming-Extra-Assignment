...
//=== Window Functions ===
void SDLFrame::CreateFrame(EliteWindow* const pWindow)
{
...
void SDLFrame::SubmitAndFlipFrame(EImmediateUI* const pImmediateUI)
{
	//Set Viewport Size
	const Elite::WindowParams& windowParams = m_pWindow->GetCurrentWindowParameters();
